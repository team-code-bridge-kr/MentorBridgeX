export const NAV_ICON_PATHS = {
  ...
  paperclip: <><path d="M20 11.5 12.5 19a4.5 4.5 0 0 1-6.4-6.4l8-8a3 3 0 0 1 4.3 4.3l-8 8a1.5 1.5 0 0 1-2.2-2.1l7.4-7.4"/></>,
  ...
  /* 이모지 대체용 — 기존과 같은 24x24 / stroke 1.7 선 스타일 */
  trash:     <><path d="M4.5 6.5h15"/><path d="M9.5 6.5V4.6h5v1.9"/><path d="M6.6 6.5 7.5 20a1 1 0 0 0 1 .9h7a1 1 0 0 0 1-.9l.9-13.5"/><path d="M10 10.4v6.2M14 10.4v6.2"/></>,
  dot:       <><circle cx="12" cy="12" r="4.6"/></>,
  pen:       <><path d="M4 20.2h4L19.4 8.8a2.1 2.1 0 0 0-3-3L5 17.2z"/><path d="M14.6 6.7l3 3"/></>,
  link:      <><path d="M10.2 13.6a3.6 3.6 0 0 0 5.1 0l3-3a3.6 3.6 0 0 0-5.1-5.1l-1.5 1.5"/><path d="M13.8 10.4a3.6 3.6 0 0 0-5.1 0l-3 3a3.6 3.6 0 0 0 5.1 5.1l1.5-1.5"/></>,
  close:     <><path d="M6.2 6.2l11.6 11.6M17.8 6.2 6.2 17.8"/></>,
  lock:      <><rect x="4.6" y="10.4" width="14.8" height="9.6" rx="2"/><path d="M8 10.4V7.6a4 4 0 0 1 8 0v2.8"/></>,
  key:       <><circle cx="8.4" cy="15.2" r="3.6"/><path d="M11 12.6 19.2 4.4"/><path d="M16.6 7l2 2M14.2 9.4l2 2"/></>,
  idea:      <><path d="M9.6 17.6h4.8"/><path d="M10.6 20.4h2.8"/><path d="M12 3.6a6 6 0 0 0-3.4 10.9c.5.4.8 1 .8 1.6h5.2c0-.6.3-1.2.8-1.6A6 6 0 0 0 12 3.6z"/></>,
  bug:       <><rect x="8" y="8" width="8" height="11" rx="4"/><path d="M9.6 8V6.6a2.4 2.4 0 0 1 4.8 0V8"/><path d="M8 11.6H4.6M8 15.6H5.2M16 11.6h3.4M16 15.6h2.8"/><path d="M6.6 6.8 8 8.2M17.4 6.8 16 8.2"/></>,
  image:     <><rect x="3.6" y="5" width="16.8" height="14" rx="2"/><circle cx="8.6" cy="10" r="1.5"/><path d="M4.2 16.6 8.6 12.4l3.4 3 3-2.6 5.2 4"/></>,
  refresh:   <><path d="M20 12a8 8 0 1 1-2.4-5.7"/><path d="M20 3.6V8h-4.4"/></>,
  tag:       <><path d="M20.4 12.6 12.6 20.4a2 2 0 0 1-2.8 0l-6.2-6.2a2 2 0 0 1-.6-1.4V4.6a2 2 0 0 1 2-2h8.2a2 2 0 0 1 1.4.6l5.8 5.8a2 2 0 0 1 0 2.8z"/><circle cx="7.6" cy="7.6" r="1.4"/></>,
