export const NAV_ICON_PATHS = {
  ...
  /* 취향 표시. 따봉은 "이런 주제 더", 손사래(x 표시)는 "관심 없다"이다.
     이모지(👍/🙅)를 쓰지 않는 이유는 저장 아이콘과 같다 — 폰트마다 그림이 다르다. */
  thumbUp:   <><path d="M7 10.5v9H4.6a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1z"/><path d="M7 10.5 11.4 4a2 2 0 0 1 3.4 2l-1.2 4.5h4.7a2 2 0 0 1 1.9 2.5l-1.5 5.6a2 2 0 0 1-1.9 1.4H7"/></>,
  thumbDown: <><path d="M7 13.5v-9H4.6a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1z"/><path d="M7 13.5 11.4 20a2 2 0 0 0 3.4-2l-1.2-4.5h4.7a2 2 0 0 0 1.9-2.5l-1.5-5.6A2 2 0 0 0 16.8 4H7"/></>,
  /* 저장(북마크). 이모지(🔖)는 폰트마다 그림이 달라 선 아이콘들 사이에서 혼자
     튄다. 채운 모양은 저장된 상태다 — 색만으로 알리지 않는다. */
  bookmark:  <><path d="M6.5 4.5h11a1 1 0 0 1 1 1v14l-6.5-4-6.5 4v-14a1 1 0 0 1 1-1z"/></>,
  bookmarkOn:<><path d="M6.5 4.5h11a1 1 0 0 1 1 1v14l-6.5-4-6.5 4v-14a1 1 0 0 1 1-1z" fill="currentColor"/></>,
  /* 뒤로 가기(`<`). 화살표(←)가 아니라 갈매기 하나다 — 뒤로 가기는 "왼쪽으로
     이동"이 아니라 "한 겹 나가기"라, 선이 없는 쪽이 그 뜻에 가깝다. */
  chevronLeft:<><path d="M14.5 5.5 8 12l6.5 6.5"/></>,
  // 목록 줄 끝의 "더 있다" 표시. 글자 › 는 폰트마다 크기·두께가 달라 선
  // 아이콘들 사이에서 혼자 얇게 뜬다.
  chevronRight:<><path d="M9.5 5.5 16 12l-6.5 6.5"/></>,
  // 접힘/펼침 표시. 펼치면 CSS 로 90도 돌린다 — 아이콘을 둘 두면 회전이
  // 아니라 교체가 되어, 여닫는 것이 같은 물건이라는 느낌이 사라진다.
  ...
  /* 올리기. 상자 위로 화살표가 솟는 모양 — "내 것을 여기로 보낸다" 는 뜻이
     화살표 방향에 있다. 내려받기(반대 방향)와 헷갈리지 않게 상자를 아래에 둔다. */
  upload:    <><path d="M12 16V4.5"/><path d="M7.5 9 12 4.5 16.5 9"/><path d="M4.5 15v3.5a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5V15"/></>,
  /* 로그아웃. 사이드바 아래에 손으로 그린 svg 로 박혀 있던 것을 옮겨 왔다 —
     혼자만 선 두께와 색이 달라서, 옆의 아이콘들보다 흐리게 떠 있었다. */
